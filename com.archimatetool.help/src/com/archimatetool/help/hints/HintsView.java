...
implements IContextProvider, IHintsView, ISelectionListener, IComponentSelectionListener {
    ...
    private Browser createBrowser(Composite parent) {
        ...
        try {
            ...
            // Enable JS
            browser.setJavascriptEnabled(ArchiPlugin.PREFERENCES.getBoolean(IPreferenceConstants.HINTS_BROWSER_JS_ENABLED));
            
            // Don't allow external links if set in Preferences
            if(!ArchiPlugin.PREFERENCES.getBoolean(IPreferenceConstants.HINTS_BROWSER_EXTERNAL_LINKS_ENABLED)) {
